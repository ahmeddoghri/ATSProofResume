...
class ResumeProcessor:
    """Main class that coordinates all resume processing operations"""
    
    def __init__(self, api_key=None):
        self.formatter = DocumentFormatter()
        self.parser = ResumeParser()
        self.writer = ResumeWriter(formatter=self.formatter)
        self.rewriter = ResumeRewriter(api_key=api_key, writer=self.writer)
    
    def append_ok_to_sentences_with_full_formatting(self, input_path, output_path):
        """
    ...
    def process_resume(self, resume_path, job_description, output_path):
        """
        ...
        """
        self.append_ok_to_sentences_with_full_formatting(resume_path, output_path)
